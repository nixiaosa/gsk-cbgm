<template>
    <div class="answerCompetitionManage">
        ...
        <table-list :data="tabelList.data" @change="tabelListChange" name="AnswerCompetitionManage"/>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            checkDetail(id) {
              // 查看详情
                this.$router.push({path: `answerCompetitionCreate/${id}/CHECK`})
            },
            getTaskDetail(id) {
              // 领取详情
                this.$router.push({path: 'taskGetDetails/' + id})
            },
            editTask(id) {
                this.$router.push({path: `answerCompetitionCreate/${id}/EDIT`})
            },
            endTask(id) {
              // 结束任务
            ...
            headerChange() {
                // header按钮触发
                this.$router.push({path: 'answerCompetitionCreate'})
            },
