 ...
 * @LastEditTime: 2020-09-01 10:04:40
  ...
  <div class="casedetail">
    ...
    <el-tabs v-model="activeName" type="card" @tab-click="handleClick">
      ...
      <el-tab-pane label="参与用户列表" name="second">
        <Participants v-if="activeName === 'second'" :id="id" :page="page"></Participants>
      </el-tab-pane>
      <el-tab-pane label="统计分析" name="third">
        <statiStical v-if="activeName === 'third'" :id="id"></statiStical>
        <!--<Detail></Detail>-->
      </el-tab-pane>
    </el-tabs>
  </div>
