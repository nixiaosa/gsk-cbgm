<template>
  <div class="modelist">
    ...
    <header-content
      :title="headerTitle"
      :opertions="opertionsThird"
      @header-btn-click="headerClickThird"
      v-if="activeName == 'thirdNav'"
    ></header-content>
    <div>
      <el-tabs v-model="activeName" @tab-click="tabClick">
        ...
        <el-tab-pane label="三级栏目" name="thirdNav">
          <third-nav :table-data="tableDataThird" @change="navChange"/>
        </el-tab-pane>
      </el-tabs>
    </div>
...
export default {
  ...
  methods: {
    ...
    getNavList: async function(page) {
      ...
      var res = await http.post(api.navigation.list, params);
      if (res.data.code === 0) {
    ...
    navChange(v) {
      if (v == "firstNav") {
        ...
        this.getThirdList(this.currentPage);
      }
    },
    errorTost(val) {
      // 错误提示
