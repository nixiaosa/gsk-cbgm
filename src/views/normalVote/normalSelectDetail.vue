 ...
 * @LastEditTime: 2020-10-14 11:08:12
...
<template>
  <div class="casedetail">
    ...
    <selectDetail v-if="activeName === 'first'" :id="id"></selectDetail>
  </div>
</template>

<script>
  import HeaderContent from '@/components/header-content'
  import selectDetail from './base/selectDetail'
