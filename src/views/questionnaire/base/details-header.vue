<!--
 * @Author: your name
 * @Date: 2020-08-17 10:39:02
 * @LastEditTime: 2020-08-18 16:30:31
 * @LastEditors: your name
 * @Description: In User Settings Edit
 * @FilePath: /CBGM/src/views/questionnaire/base/details-header.vue
-->
<template>
  <div id="detailsHeader">
    <el-form-item v-for="(item,index) in itemData" :key="index" :label="item.label">
      <span v-if="item.label=='任务类型:'">调研问卷任务</span>
