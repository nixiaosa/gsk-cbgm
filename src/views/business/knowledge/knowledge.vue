<template>
  <div class="modelist">
    ...
    <el-form :model="form" label-width="100px" :rules="artRules" ref="artForm">
      ...
      <el-form-item label="栏目:" v-if="isOld === 0">
      ...
      <el-form-item label="封面图:" prop="name" class="star">
        <el-upload
      ...
      <el-form-item label="附件：">
        ...
        >
          ...
          >注：支持附件类型为：doc、docx、ppt、pptx、xls、xlsx、pdf、zip、rar、txt、jpg、jpeg、png，大小不超过50M ，最多上传20个附件
          </div>
        </el-upload>
      </el-form-item>
    </el-form>
    ...
    >
      <el-form :model="form" style="width:100%">
        <el-form-item label="类型：" prop="keyword">
          <el-radio @change="radioChange" v-model="radio" label="1">视频</el-radio>
          <el-radio @change="radioChange" v-model="radio" label="2">音频</el-radio>
        </el-form-item>
      ...
      <div slot="footer" class="dialog-footer">
        <el-button @click="radioChange(), schedule = false">取 消</el-button>
