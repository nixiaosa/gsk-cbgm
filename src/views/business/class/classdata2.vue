      ...
      <el-tabs type="border-card" v-model="topActiveName">
        ...
        <el-tab-pane label="观看统计" name="new" v-else>
          <div v-if="topActiveName === 'new'">
            <el-tabs v-model="activeName" @tab-click="handleClick">
              <el-tab-pane label="直播用户" name="1" v-if="type===1 || type===3">
                <LiveListV2 version="2" ref="live1"></LiveListV2>
              </el-tab-pane>
              <el-tab-pane label="视频用户" name="2" v-if="type===2">
                <VideoListV2 version="2" ref="video1"></VideoListV2>
              </el-tab-pane>
              <el-tab-pane label="视频用户" name="3" v-if="type===1 || type===3">
                <WatchListV2 version="2" ref="watchl"></WatchListV2>
              </el-tab-pane>
            </el-tabs>
          </div>
        </el-tab-pane>
...
import VideoListV2 from './base/videoV2'
import LiveListV2 from './base/liveV2'
import WatchListV2 from './base/watchV2'
import LiveListV3 from './base/liveV3'
import WatchStreamList from './base/watchStreamList'
import HeaderContent from '@/components/header-content'
import SignUpV2 from "@/views/business/class/dataStatistics/SignUpV2";
import SignInV2 from "@/views/business/class/dataStatistics/SignInV2";
import WatchReportForm from "@/views/business/class/statistics/watchReportForm";
import {mapGetters} from "vuex";
export default {
  components: {WatchReportForm,SignInV2, SignUpV2, VideoList, LiveList,WatchList,HeaderContent, VideoListV2, LiveListV2,WatchListV2, LiveListV3, WatchStreamList},
  data() {
    return {
      ...
      activeName2: this.$route.query.activeName,//区分直播、点播
    }
  },
  created() {
