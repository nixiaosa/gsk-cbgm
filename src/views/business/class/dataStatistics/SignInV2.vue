<!--
 * @Author: your name
 * @Date: 2021-01-27 09:38:58
 * @LastEditTime: 2021-08-13 13:42:45
 * @LastEditors: Please set LastEditors
 * @Description: In User Settings Edit
 * @FilePath: /CBGM/src/views/business/class/dataStatistics/SignInV2.vue
-->
<template>
  <div>
    ...
    <!-- <table-list name="SignIn" :data="dataList"/> -->
...
export default {
  ...
  methods: {
    ...
    exportList() {
      ...
      // this.$http.post(this.$api.signIn.export, params).then(res => {
    ...
    getSignUp() {
      ...
      // this.$http.post(this.$api.signIn.list, params).then(res => {
