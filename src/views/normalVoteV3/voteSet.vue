 ...
 * @LastEditTime: 2021-09-23 10:25:22
...
<template>
  <div class="casedetail">
    ...
    <voteSetDetail v-if="activeName === 'first'" :id="id"></voteSetDetail>
  </div>
</template>

<script>
  import HeaderContent from '@/components/header-content'
  import voteSetDetail from './base/voteSetDetail'
  ...
  export default {
    ...
    data() {
      return {
        headerTitle: '投票管理-->投票设置',
        opertions: ['返回'],
        activeName: 'first',
        // id: this.$route.params.id,
        id: String(this.$route.query.voteId),
        page: this.$route.query.page
      }
    },
    activated() {
      // this.id = this.$route.params.id
      this.id = String(this.$route.query.voteId)
    },
    mounted() {
