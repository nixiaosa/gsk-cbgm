    ...
    <div>
      <el-tabs v-model="activeName" @tab-click="tabClick">
        ...
        >
          ...
          <TransListBack :table-data="tableData" :business-id="activeName"/>
        </el-tab-pane>
      </el-tabs>
    </div>
...
import TransListBack from "./base/transListBack";
...
export default {
  ...
  methods: {
    ...
    getList: async function(pageNum) {
      ...
      const res = await http.post(api.videoRecManageListSearch, params);
      if (res.data.code === 0) {
